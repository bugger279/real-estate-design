...
const ToggleSwitch = () => {
    ...
    return (
        <Switch>
            <input type="checkbox" className="switch__input" id="switchCheckBox1" onClick={toggleTheme} />
            <label aria-hidden="true" htmlFor="switchCheckBox1" className="switch__label">On</label>
